...
//    ImageGet_client = Node->serviceClient<rb_msgAndSrv::rbImageList>("/cube_image");
...
void MainWindow::thread_GagicGetData() {
    ...
    emit emitQmessageBox(infoLevel::warning,QString("发了请求!"));

    MagicStepRunCommand_client.call(data_srvs);
